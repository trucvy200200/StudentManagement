...
namespace day04.MyDBDataSetTableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::day04.Properties.Settings.Default.MyDBConnectionString;
        }
    ...
    public partial class stdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[std] WHERE (([Id] = @Original_Id) AND ([fname] = @Original_fna" +
                ...
                "] = @Original_gender) AND ([phone] = @Original_phone) AND ([address] = @Original" +
                "_address))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
...
SELECT Id, fname, lname, bdate, gender, phone, address, picture FROM std WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_fname, string Original_lname, System.DateTime Original_bdate, string Original_gender, string Original_phone, string Original_address) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, string fname, string lname, System.DateTime bdate, string gender, string phone, string address, byte[] picture, int Original_Id, string Original_fname, string Original_lname, System.DateTime Original_bdate, string Original_gender, string Original_phone, string Original_address) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
            if ((fname == null)) {
                throw new global::System.ArgumentNullException("fname");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fname, string lname, System.DateTime bdate, string gender, string phone, string address, byte[] picture, int Original_Id, string Original_fname, string Original_lname, System.DateTime Original_bdate, string Original_gender, string Original_phone, string Original_address) {
